...
{
    public class TempCategoryController : Controller
    {
        private readonly MyDbContext _context;

        public TempCategoryController(MyDbContext context)
        {
            _context = context;
        }
        ...
        // GET: TempCategory/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: TempCategory/Create
